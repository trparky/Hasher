...
```powershell
git clone https://github.com/trparky/Hasher.git
cd .\Hasher\
```
...
### Compile Time
```powershell
& "C:\Program Files (x86)\Microsoft Visual Studio\2022\BuildTools\MSBuild\Current\Bin\MSBuild.exe" ".\Hasher.sln" /t:Rebuild /p:Configuration=Debug
& "C:\Program Files (x86)\Microsoft Visual Studio\2022\BuildTools\MSBuild\Current\Bin\MSBuild.exe" ".\Hasher.sln" /t:Rebuild /p:Configuration=Release
```
